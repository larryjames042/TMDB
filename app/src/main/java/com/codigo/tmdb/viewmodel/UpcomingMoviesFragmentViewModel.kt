...
@HiltViewModel
class UpcomingMoviesFragmentViewModel @Inject constructor(val app : Application, val movieRepository: TmdbRepository) : AndroidViewModel(app) {
    ...
    init {
        viewModelScope.launch {
            networkResponseState.value = movieRepository.refreshUpcomingMovies()
        }
    }

    val movies = movieRepository.upcomingMovies
